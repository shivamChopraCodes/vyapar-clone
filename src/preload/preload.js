...
contextBridge.exposeInMainWorld('vyapar', {
  ...
  getTelegramSettings: () => ipcRenderer.invoke('telegram:getSettings'),
  setTelegramToken: (token) => ipcRenderer.invoke('telegram:setToken', token),
  getTelegramStatus: () => ipcRenderer.invoke('telegram:getStatus'),
  startTelegramBot: () => ipcRenderer.invoke('telegram:start'),
  stopTelegramBot: () => ipcRenderer.invoke('telegram:stop'),
  approveTelegramChat: () => ipcRenderer.invoke('telegram:approveChat'),
  clearTelegramChat: () => ipcRenderer.invoke('telegram:clearChat'),
  sendTelegramTest: () => ipcRenderer.invoke('telegram:sendTest'),
